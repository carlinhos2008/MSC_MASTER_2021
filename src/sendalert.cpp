...
2. run masterstakecoind with -printalert or -sendalert like this:
   /path/to/masterstakecoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.masterstakecoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/MasterStakeCoin Core:0.12.0.58/"));
