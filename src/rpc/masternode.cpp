...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner MasterStakeCoin address\n"
            "  payee          - Print the masternode payout MasterStakeCoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting MasterStakeCoin address\n"
        );
}
...
UniValue masternode_outputs(const JSONRPCRequest& request)
{
    ...
    pwallet->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_2500);
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "masterstakecoin",               "masternode",             &masternode,             true,  {} },
    { "masterstakecoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "masterstakecoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "masterstakecoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
