...
#define BOOST_TEST_MODULE MasterStakeCoin Test Suite

#include "test_masterstakecoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_masterstakecoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
