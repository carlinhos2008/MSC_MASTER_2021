...
EXPECTED_HOLDER_NAMES = [
    ...
    "The MasterStakeCoin Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a MasterStakeCoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The MasterStakeCoin Core developers'
...
Arguments:
    <base_directory> - The base directory of MasterStakeCoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the MasterStakeCoin Core repository.
"""
