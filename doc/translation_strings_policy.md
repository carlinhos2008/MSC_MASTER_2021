...
This document provides guidelines for internationalization of the MasterStakeCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `masterstakecoin_en.ts` remains unchanged.
