...
This mechanism has been integrated into Bitcore-Node-MasterStakeCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/masterstakecoinpay/insight-api-masterstakecoin#web-socket-api](https://github.com/masterstakecoinpay/insight-api-masterstakecoin#web-socket-api)
* API: [https://github.com/masterstakecoinpay/insight-api-masterstakecoin#instantsend-transactions](https://github.com/masterstakecoinpay/insight-api-masterstakecoin#instantsend-transactions)
