...
from test_framework.test_framework import MasterStakeCoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(MasterStakeCoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as MasterStakeCoinTestFramework doesn't support this atm)
